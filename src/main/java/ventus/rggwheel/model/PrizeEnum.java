...
public enum PrizeEnum {
    ...
    AUCTION_GAME("Auction Game", "A 3-minute timer will be started. The person who donated the largest single donation chooses next game on the current platform.", "Auction Game"),
    COIN_FLIP("Double or Nothing", "Player can bet any amount of coins on a coin flip! Good luck!", "Coin flip"),
    BAG("Mysterious Bag", "A random number of coins is added/substracted from -30 to +50", "Mysterious Bag"),
    HOT_STREAK("Hot Streak", "Coins are awarded to the player for his current completed games streak at +5 coins per game. Use !rgg for more info", "Heads/Tails"),
